...
<ul> 
    ...
    <li><i class="fa-solid fa-paper-plane"></i><a href="useruplaodspages.php"><b>User Uploaded Request</b></a></li>
    ...
    <li><i class="fa-sharp fa-solid fa-file"></i><a href="viewalluser.php"><b>View all Files</b></a></li>
